    ...
    <Section graphics={graphics}>
      <div className="size-full text-primary text-center flex flex-col items-center">
        ...
        <Link
          ...
          className="text-lg md:text-3xl bg-white px-2 md:px-4 mt-4 md:mt-10 py-1 md:py-3 block w-fit rounded-lg transition-all font-semibold hover:border-shine pointer-events-none opacity-50"
        >
          REGISTRATION CLOSED
        </Link>
      </div>
